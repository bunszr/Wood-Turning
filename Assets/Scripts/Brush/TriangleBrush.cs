...
public class TriangleBrush : AbsBrush
{
    Vector3[] brushPoints;
    Vector3[] pointDir;
    ...
    {
        base.Awake();
        brushPoints = Utility.GetBrushPoints(15, colider, transform.position);
    ...
    public override void SetIntersectPairIndex(ref List<BrushVertexInfo> brushVertexInfos)
    {
        ...
        {
            for (int brushIndex = newIntersectPointIndex; brushIndex < brushPoints.Length; brushIndex++)
            {
